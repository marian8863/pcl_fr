...
<!-- Mirrored from finder.createx.studio/car-finder-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jul 2022 15:23:03 GMT -->
...
<head>
  ...
  <body class="bg-dark">
    ...
    <div class="offcanvas offcanvas-end" id="demo-switcher">
      ...
      <div class="offcanvas-footer border-top"><a class="btn btn-primary btn-lg w-100" href="https://themes.getbootstrap.com/product/finder-directory-listings-template-ui-kit/" target="_blank" rel="noopener"><i class="fi-cart fs-lg me-2"></i>Buy Finder</a></div>
    </div>
        ...
        <div class="container d-flex justify-content-center position-relative zindex-5 text-center">
          <div class="col-lg-8 col-md-10 col-12 px-0">
            ...
            <div class="ratio ratio-16x9 mx-auto mb-lg-5 mb-4 py-4" style="max-width: 556px;">
              <lottie-player class="py-4" src="json/animation-car-finder-404.json" background="transparent.html" speed="1" loop autoplay></lottie-player>
            </div>
            <p class="h2 mb-lg-5 mb-4 pb-2 text-light">The requested page doesn’t exist</p><a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="http://localhost/pci">Go to homepage</a><a class="btn btn-lg btn-outline-light w-sm-auto w-100 mb-3" href="contact.php">Contact us</a>
          </div>
        </div>
      </section>
    </main>
    ...
    <script src="vendor/%40lottiefiles/lottie-player/dist/lottie-player.js"></script>
    <!-- Main theme script-->
    <script src="js/theme.min.js"></script>
  </body>

<!-- Mirrored from finder.createx.studio/car-finder-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Jul 2022 15:23:05 GMT -->
</html>